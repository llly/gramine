 ...
 * [`g_pal_public_state->private_user_address_start`, `g_pal_public_state->private_user_address_end`). */
...
/* First tries to bookkeep in the range [`g_pal_public_state->private_user_address_start`, `aslr_addr_top`)
